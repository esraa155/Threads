...
public class main {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 693, 440);
		...
		textField_4.setBounds(28, 75, 176, 29);
		frame.getContentPane().add(textField_4);
		textField_4.setColumns(10);
		
		txt_outfile = new JTextField();
		txt_outfile.setBounds(28, 115, 176, 29);
		...
		btn1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
		        ...
		        Thread prodThread = new Thread(new Producer(sharedQueue, n,textField_1,textField_2,textField_3,textField_4), "Producer");
		...
		JLabel lblBuffer = new JLabel("Buffer Size");
		lblBuffer.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblBuffer.setBounds(214, 76, 94, 22);
		frame.getContentPane().add(lblBuffer);
		
		JLabel lblOutputFile = new JLabel("Output File");
		lblOutputFile.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblOutputFile.setBounds(215, 122, 145, 22);
		...
		lblTheLargestPrime.setBounds(28, 221, 302, 22);
		...
		lblofElementsprime.setBounds(28, 269, 280, 22);
		...
		lblTimeElapsedSince.setBounds(28, 317, 280, 22);
		...
		textField_1.setBounds(320, 220, 156, 29);
		frame.getContentPane().add(textField_1);
		
		textField_3 = new JTextField();
		textField_3.setEditable(false);
		textField_3.setColumns(10);
		textField_3.setBounds(316, 316, 156, 29);
		frame.getContentPane().add(textField_3);
		
		textField_2 = new JTextField();
		textField_2.setEditable(false);
		textField_2.setColumns(10);
		textField_2.setBounds(318, 268, 158, 29);
